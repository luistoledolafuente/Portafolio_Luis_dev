            ...
            <div className="p-6 rounded-2xl bg-white/50 dark:bg-white/5 backdrop-blur border border-slate-200/50 dark:border-white/10">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3">
                  <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-purple-500/10 text-purple-600 dark:text-purple-400">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-slate-500 dark:text-slate-500">GitHub</p>
                    <a
                ...
                <li className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-slate-500 dark:text-slate-500">LinkedIn</p>
                    <a
